...
from project.habitat_baselines.common.utils import CategoricalNet, DiagGaussianNet
from project.habitat_baselines.rl.models.rnn_state_encoder import RNNStateEncoder
from project.habitat_baselines.rl.models.simple_cnn import SimpleCNN
...
class Policy(nn.Module):
    def __init__(self, net, action_space):
        ...
        if isinstance(action_space, gym.spaces.Box):
            ...
            self.action_distribution = DiagGaussianNet(
                self.net.output_size, action_space.shape[0]
            )
        else:
            assert isinstance(action_space, gym.spaces.Discrete)
            self.action_distribution = CategoricalNet(
                self.net.output_size, self.action_space.n
            )
